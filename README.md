...
The only file we modify is `particle_filter.cpp` in the `src` directory. The file contains the scaffolding of a `ParticleFilter` class and some associated methods. 

If you are interested, take a look at `src/main.cpp` as well. This file contains the code that will actually be running our particle filter and calling the associated methods.
